...
ui.layout(
    <drawer id="drawer">
        <vertical>
            <appbar>
                <toolbar id="toolbar" bg="#ff4fb3ff" title="学习测试助手"/>
                        ...
                        <vertical gravity="center" layout_weight="1">
                            <card w="*" h="70" margin="10 5" cardCornerRadius="2dp" cardElevation="1dp" foreground="?selectableItemBackground">
                                <horizontal gravity="center_vertical">
                                    ...
                                    <spinner id="script_chosen" marginLeft="4" marginRight="6" entries="学习测试四合一Pro|学习测试四合一|Study改" />
                                </horizontal>
                            </card>
                            <card w="*" h="70" margin="10 5" cardCornerRadius="2dp" cardElevation="1dp" foreground="?selectableItemBackground">
                                <horizontal gravity="center_vertical">
...
ui.emitter.on("options_item_selected", (e, item) => {
    switch (item.getTitle()) {
        case "日志":
            ...
            break;
        case "关于":
            alert("关于", "学习测试助手 v" + latest_version);
            break;
        case "Github":
...
ui.start.click(function () {
    ...
    threads.start(function () {
        ...
        execution = engines.execScript("学习测试助手", http.get(url).body.string());
    });
});
