                        ...
                        <vertical id="ttxs_pro" gravity="center">
                            ...
                            <horizontal  gravity="center_vertical" padding="5 5" >
                                ...
                                <vertical padding="10 8" h="auto" w="0" layout_weight="1">
                                    ...
                                    <text w="auto" textColor="#999999" textSize="12sp" text="若已root或虚拟机等去除截图限制的选最后一个" />
                                    <spinner id="ttxs_pro_dingyue" marginLeft="4" marginRight="6" entries="不做|正序订阅（仅支持旧版）|只订阅年度上新（已root版选这个--2022年上线）" />
                                </vertical> 
                            </horizontal>
                            <horizontal  gravity="center_vertical" padding="5 5" >
                                <View bg="#00BFFF" h="*" w="10"  ></View>
